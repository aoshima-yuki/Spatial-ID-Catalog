...
const i18n = {
  ja: {
    ...
    overviewTitle: "概要",
    overviewBody: "本ページは、GitHub上で公開されている空間ID関連OSSの候補を自動収集し、リストとして表示するものです。掲載内容は、空間IDに関するOSSの発見性を高めるための参考情報です。",
    ...
    method3: "候補リポジトリごとにメタデータとREADMEを取得し、検索・判定対象項目にキーワードが含まれるかを確認します。",
    method4: "除外リストに登録されたリポジトリを除外し、Stars数及び更新日時を基準に並べ替えてリストデータを生成します。",
    targetTitle: "検索・判定対象項目",
    target1: "リポジトリ名（name）",
  ...
  en: {
    ...
    overviewBody: "This page automatically collects candidate OSS repositories related to Spatial ID on GitHub and displays them as a list. The listed information is provided as reference information to improve discoverability of Spatial ID related OSS.",
    ...
    method3: "For each candidate repository, metadata and README content are retrieved and checked against the search and matching target fields.",
    ...
    targetTitle: "Search and matching target fields",
